...
<head>
    ...
    <link  href="searcbar.css" rel="stylesheet" type="text/css">
...
<!--for the toggle version-->
    ...
    <input type="text" id="input" class="input" name="id" placeholder="Enter id to search"/> <br/>
    <input id="submit" class="submit" type="submit" name="search" value="Search Data"/>
</form>
